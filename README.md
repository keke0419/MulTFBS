...
## Data preparation
After downloading the data according to https://bitbucket.org/wenxiu/sequence-shape/get/2159e4ef25be.zip, the data should be trimmed first to ensure equal length of the data, and then the data should be placed in the `PBMdatas` directory for the convenience of subsequent operation and experiment.
 *  Example: 
 ```
